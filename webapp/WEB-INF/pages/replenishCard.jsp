...
<div class="wrapper">
    <div class="links">
        ...
        <a class="btnLinks" id="selectedLink" href="/replenish">Пополнить карту</a>
    ...
    <div class="inputWrapper">
        ...
        <c:if test="${!empty cardList}">
            <form id="form" method="POST" action="/bankPage/replenish" role="form">
                ...
                <div class="form-group">
                    <label for="pswRep"><span class="glyphicon glyphicon-eye-open"></span> Введите пин код</label>
                    <input type="password" id="pswRep" name="pincode" maxlength="4" class="form-control"
                ...
                <br>
                <button type="submit" class="send"> Пополнить</button>
            </form>
        </c:if>
    </div>
</div>
